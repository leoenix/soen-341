    ...
    return (
        <>
            <Box>
                        ...
                        <div>
                            <div
                                ...
                                style={{
                                    color: "black",
                                    padding: "15px 40px"
                                }}>{specificQuestion[0] && specificQuestion[0].description}</div>
                            {" "}
                        </div>
                    </div>
                ...
                {comments && comments.length > 0 && comments.filter((a, index) => comments[index].type === 'question').map((a, newindex) => (
                    ...
                    <>
                        ...
                        <div style={{display: "flex", justifyContent: "space-between"}}>
                            <div style={{color: "black", display: "flex"}}>
                                ...
                                <div>
                                    {" "}
                                    <VotingArrows total={a.total === null ? 0 : a.total} userVote={a.uservote}
                                                  disabled={!user} style={{cursor: !user && 'not-allowed'}}
                        ...
                        }).map((comment, newindex) => (<>    <Comments>	<span
                                style={{display: "inline-flex"}}><VotingArrows
                                size={"small"}

                                total={comment.total === null ? 0 : comment.total} userVote={comment.uservote}
                                disabled={!user}
